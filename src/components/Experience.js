       ...
       return (
        <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[75%] mx-auto flex flex-col items-center justify-between md:w-full'>
            ...
            <motion.div initial={{y:50}} whileInView={{y:0}} transition={{duration:0.5, type:"spring"}} >
                <h3 className='capitalize text-2xl font-bold dark:text-light sm:text-xl xs:text-lg'>{position}&nbsp;<a href="#" className='text-primary capitalize dark:text-primaryDark '>@{company}</a></h3>
  ...
  return (
    <div className='my-64'>
        ...
        <div ref={ref } className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
            ...
            <ul className='w-full flex flex-col items-start justify-between ml-4 md:ml-16 sm:ml-14 '>
