...
function Card({src,title,key_techs,description,link,github,color1,color2,color3}) {
    return (
      <>
       <div className={`p-4 flex flex-col w-[400px] h-[500px] rounded-lg border-2 border-solid border-light dark:border-dark bg-gradient-to-b  ${color1} ${color2} ${color3} `}>
      ...
      h-[80%] rounded-[2rem] bg-dark  "/>
          ...
          <Link href="/" target="_blank" className="ml-4 rounded-lg  p-2 px-6 text-lg font-semibold border-2 border-solid border-transparent bg-dark text-light hover:text-dark hover:border-dark hover:bg-light
              ">
            Visit Project
          </Link>
        </div>
